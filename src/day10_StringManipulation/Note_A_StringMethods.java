...
public class Note_A_StringMethods {
        ...
        public static void main(String[] args) {
             ...
             *  indexOf un sondan olan hali fakat index numaraları değişmez cunku indeksi bastan baslar.
             */
            ...
            System.out.println(ss.substring(10)); //ava gibi olsa: 10.index dahil(inclusive) sonuna kadar tum Stringi parcalayip alir
            ...
            //System.out.println(str.substring(8, 7)); // RTE denenir ama calismaz.
             ...
             * ya da metinle degistirilmesini saglar. Sonuc String'dir..
             *
             */
             ...
             * Replace ile aynı sadece ilk bulunanı değiştirir
             replace() hepsini degistirir, ama replaceFirst() ilk buldugunu degistirir.
             */
             ...
             * Sonuc boolean -->  true veya false dir.
             *
             * equals()
            ...
            /**Equals() methodu ve Cift Esittir (==) karsilastirma operatoruFarki
             */
