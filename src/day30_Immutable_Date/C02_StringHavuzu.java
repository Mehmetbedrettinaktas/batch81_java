...
public class C02_StringHavuzu {
    public static void main(String[] args) {
        ...
        // equals method() 'u tatmamen icerikle ilgileniyor
        ...
        System.out.println("s1-s4: "+(str1==str4)); // true
         ...
         yani sadece icerikle ilgileniyor
        ...
        2- eger esitligin saginda bir method calisiyors veya +(herhangi bir islem)
        ile islemi yapiliyorsa String immutable oldugundan degisikligi
        kaydetmek uzere hen´men bir kopya String
