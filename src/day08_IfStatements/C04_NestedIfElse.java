...
public class C04_NestedIfElse {
    public static void main(String[] args) {
        ...
        Son rakamı 0 ise ekrana “5’e bölünen  çift sayı” yazdırın. Son rakamı 0 değil ise
        ...
        // sayinin 5' bolunup bolunmemesi
        // sayin in son basamaginin sifir olup olmamasi

        if (sayi < 1000 || sayi > 9999) {
            System.out.println("Lutfen 4 basamakli sayi giriniz");
        } else if (sayi % 5 == 0) { // sayi 4 basamakli ve 5' tam bolunebiliyor
            if (sayi % 10 == 0) {
                System.out.println("5' e bolunen cift sayi");
            } else {
                System.out.println("5'e bolen tek sayi");
            }
