...
public class C03_Contains {
    public static void main(String[] args) {
        ...
        Soru 3- Kullanicidan aldiginiz bir ismin verilen
        array’de olup olmadigini kontrol edip,bize
    ...
    public static boolean containss(String[] isimler, String arananIsim) {
