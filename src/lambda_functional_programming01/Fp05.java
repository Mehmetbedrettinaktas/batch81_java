...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println("ortalamaPuanlarVerilenSayidanBuyukMu(coursesList,75) = " +
                ortalamaPuanlarVerilenSayidanBuyukMu(coursesList,93 ));
        System.out.println("kelimeKursAdlariIcindeVarMi = " + kelimeKursAdlariIcindeVarMi(coursesList, "Turkish")); // true
        ortalamasıEnYuksekKursunAdiniYazdir(coursesList);
        System.out.println("ortalamaPuanaGoreSiralaVeIlkVerilenleriAtla(coursesList,1) = " + ortalamaPuanaGoreSiralaVeIlkVerilenleriAtla(coursesList, 3));
    ...
    public static void ortalamasıEnYuksekKursunAdiniYazdir(List<Courses>list){
     String sonuc= list.stream().sorted(Comparator.comparing(Courses::getAverageScore).reversed()).findFirst().get().getCourseName();
        System.out.println("sonuc = " + sonuc); //sonuc = Turkish Night
