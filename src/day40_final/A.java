...
public class A {
   ...
   icinde oldugumuz class'dan bu variable'a baska deger atanmasi mumkun degildir.

   madem ki degeri degistirilemiyor genelde static de yaparak
   bu variable'a erisim kolaylastirilabilir ve genelde
   static final olarak belirlenen variable isimleri BUYUK HARFLE yazilir
